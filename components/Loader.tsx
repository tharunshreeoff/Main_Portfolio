...
export default function Loader() {
  ...
  return (
    <div
      className={`fixed inset-0 z-[9998] flex flex-col items-center justify-center gap-7 bg-ink transition-all duration-700 ${
        out ? 'pointer-events-none opacity-0' : 'opacity-100'
      }`}
      aria-hidden={out}
    >
      <div className="font-display text-[43px] font-black text-gradient animate-pulse">TS</div>
      <div className="h-[1.5px] w-48 overflow-hidden bg-surface2">
